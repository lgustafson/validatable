...
Gem::Specification.new do |s|
  s.name = "lgustafson-validatable"
  s.version = "1.8.5"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Jay Fields", "John Nunemaker", "Leif Gustafson"]
  s.date = "2012-11-05"
  s.description = "Validatable is a library for adding validations.  Now compatible with Ruby 1.9.2+"
  s.email = "leif@aktechnicalconsultants.com"
  s.extra_rdoc_files = [
    "README.rdoc"
  ]
  s.files = [
